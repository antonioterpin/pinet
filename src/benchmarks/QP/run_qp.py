...
def evaluate_instance(
    ...
    eqcv_val_hcnn = jnp.abs(
        a[0] @ predictions.reshape(a.shape[2]) - problem_batch[problem_idx, :, 0]
    ).max()
    ...
    if not use_dc3_dataset:
        ...
        eqcv_val = jnp.abs(
            a[0] @ loader.dataset.dataset.y_star[loader.dataset.indices[problem_idx]]
        ...
        eqcv_val = jnp.abs(
            a[0] @ loader.dataset.y_star[problem_idx]
